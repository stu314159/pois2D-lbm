function save_velocityAndPressureVTK_binaryR2reference(pressure,u,v,w,x,y,z,filename,dims)
...
fprintf(fid, 'VECTORS velocity_vectors_reference float\n');
