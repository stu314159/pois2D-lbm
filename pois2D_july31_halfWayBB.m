...
if ((run_dec ~= 'n') && (run_dec ~= 'N'))
    ...
    switch location
        ...
        case 'home'
            ...
            base_path='/home/srblair/Dropbox/matlab/jacketSDK/';
    ...
    addpath(strcat(base_path,'channel2D_RegVwPe_LBGK_ts'));
    addpath(strcat(base_path,'channel2D_RegVwPe_MRT_ts'));
    addpath(strcat(base_path,'channel2D_RegVwPe_RBGK_ts'));
    addpath(strcat(base_path,'channel2D_VW_PE_LBGK_ts'));
    addpath(strcat(base_path,'channel2D_VW_PE_LBGK_DPts'));
    addpath(strcat(base_path,'channel2D_VW_PE_LBGK_MPts'));
    addpath(strcat(base_path,'channel2D_VW_PE_MRT_ts'));
    addpath(strcat(base_path,'channel2D_VW_PE_MRT_DPts'));
