function save_displacementVTK_binaryR2reference(u,v,w,x,y,z,filename,dims)
...
fprintf(fid, 'VECTORS displacement_vectors_reference float\n');
...
fprintf(fid, '\nSCALARS DisplacementMagnitudeReference float\n'); %ASCII header
